...
<div class="result tablebtn">
	...
	<a class="waves-effect waves-light btn deep-purple accent-4" href=<?php echo "index.php?action=remove-table&db-name=".$dbname."&table-name=".$tablename;?>><i id="addline" class="tiny material-icons">warning</i> Supprimer la table</a>
</div>
<div class="result">
