...
<div class="result">
	...
	<a class="waves-effect waves-light btn deep-purple accent-4" href=<?php echo "index.php?action=modifier&db-name=".$dbname."&table-name=".$tablename;?>><i id="addline" class="tiny material-icons">library_add</i> Ajouter une entrée</a>
